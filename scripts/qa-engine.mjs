...
for (const profile of ['desktop', 'mobile']) {
  ...
  check(G, 'chapitres dans l’ordre du registre', structure.chapters.join() === 'matiere,revelation,ciel,territoire,avant,intervention,transformation,prestations,bascule,location,rendezvous,contact', structure.chapters.join());
  ...
  check(G, 'moteur actif sur la page', trackState.chapter === 'matiere' && trackState.p !== '' && /has-experience/.test(trackState.html), trackState);
