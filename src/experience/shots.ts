...
export const shots: readonly ShotDefinition[] = [
  ...
  },
  {
    ...
    framing: { position: [150, 620, 400], target: [-155, 150, -205], fov: 62, shift: [0, 0] },
    ...portrait({ position: [165, 660, 430], target: [-155, 150, -205], fov: 76 }),
    via: [[-600, 8600, -2200], [-40, 2600, -500]] as Vec3[],
    pace: { window: [0.02, 0.98], ease: 'inOut' },
    lead: 0.14,
  ...
  },
  {
    ...
    framing: { position: [140, 72, 92], target: [-155, 130, -205], fov: 52, shift: [0.12, 0] },
    ...portrait({ position: [152, 78, 100], target: [-155, 138, -205], fov: 66, shift: [0, 0.14] }),
    via: [[170, 300, 260]] as Vec3[],
    pace: { window: [0.02, 0.98], ease: 'inOut' },
    lead: 0.12,
  ...
  },
  {
    ...
    framing: { position: [15.5, 4.6, 11.5], target: [0.2, 1.05, 0.1], fov: 44, shift: [0.16, 0] },
    ...portrait({ position: [13.8, 5.2, 10.8], target: [0.1, 1.15, 0.1], fov: 56, shift: [0, 0.16] }),
